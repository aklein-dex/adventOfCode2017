...
A layer at depth 0 begins immediately inside the firewall; a layer at 
...
at depth 4 (with range 4), and a fourth layer which begins at depth 6 (also with range 4). 
...
it doesn't have time to notice you before you leave.) If you were to do this 
in the configuration above, marking your current position with parentheses, 
